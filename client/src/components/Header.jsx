    ...
    <div className='mx-8 sm:mx-16 xl:mx-24 relative'>
      <div className='text-center mt-20 mb-8'>
        ...
        <div className='inline-flex items-center justify-center gap-4 px-6 py-1.5 mb-4 border border-primary/40 bg-primary/10 rounded-full  text-sm text-primary  '>
            <p>New: AI Feature Itntegrated</p>
            <img src={assets.star_icon} alt="" className='w-2.5' />
        </div>

        <h1 className='text-3xl sm:text-6xl font-semibold sm:leading-16 text-gray-800'>Your Own <span className='text-primary '>Blogging</span> <br/> Platform.</h1>
        ...
        <form onSubmit={onSubmitHandler} className='flex justify-between max-w-lg max-am:scale-75 mx-auto border border-gray-300 bg-white rounded overflow-hidden'>
